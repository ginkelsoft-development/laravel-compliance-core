...
lokale `path`-repository meegetagd wordt — zie
[`RELEASE.md`](RELEASE.md). `scripts/check-release-readiness.sh` voert
de belangrijkste controle lokaal uit en draait ook automatisch in CI bij
elke tag-push.
