 ...
 * after it drops its own `forSubjectQuery` in favour of
 * {@see HasSubjectQuery} (tracked as a follow-up in that repo — it lives
 * in a separate package and cannot be depended on from here).
 *
 ...
 * substitute.
 */
trait FakeForgettablePolicy
{
    use HasSubjectQuery;

    public function forgettablePolicyName(): string
    {
        return 'forget';
    }
}
