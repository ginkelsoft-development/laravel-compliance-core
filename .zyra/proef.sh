#!/usr/bin/env bash
#
# Proefscript voor laravel-compliance-core (Laravel-package, geen eigen
# host-app).
#
# Dit package heeft zelf geen artisan/.env/routes/serve-entrypoint, omdat
# het de gedeelde basis is (hash chain, anonymize-strategieën, subject
# hashing) voor de GinkelSoft compliance-familie en pas nut heeft in
# combinatie met een van de familiepakketten (bv. laravel-data-retention).
# Voor lokaal proefdraaien gebruiken we daarom Orchestra Testbench: dat
# start een minimale Laravel-skeleton-app met deze package erin geladen,
# zodat je zonder aparte host-app kunt rondkijken en de testsuite kunt
# draaien.
#
# Gebruik:
